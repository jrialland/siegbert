...
FileAppender::FileAppender(const string &name, const string &extension,
                           bool rolling, int keptDays)
    : name_(name), extension_(extension), keptDays_(keptDays),
      rolling_(rolling), lastchecked_(0) {}
